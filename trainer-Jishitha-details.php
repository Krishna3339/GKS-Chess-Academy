<?php 
 // Dynamic Meta
    $pageTitle = "Trainer Details | Jishitha";
    $pageDescription = "Jishitha, Women FIDE Master at GKS Chess Academy. Learn from her international experience and achievements in chess.";
    $pageKeywords = "GKS chess coaches, Jishitha, Women FIDE Master, GKS Academy trainers, chess instructors, chess teacher Jishitha";
$pageCanonical = "https://gkschessacademy.com/trainer-Jishitha-details";
   ...
   <main>
      ...
      <section class="bd-achievements-area pt-50 pb-120">
         <div class="container">
            ...
            <div class="row">
              <div class="col-xl-5 col-lg-5 col-md-6 col-sm-12 mb-4 wow fadeInUp" data-wow-duration="1s"data-wow-delay=".3s">
                 <div class="card achievement-card">
                  ...
                  <div class="card-body">
                    ...
                    <ul>
                      <li>International Champion – Gold Medalist at the World Youth Chess Championship and Asian Youth Chess Championship</li>
                      <li><b>Common wealth Bronze Medalist (U14)</b></li>
                      <li>Multiple <b>National Championship Titles</b></li>
                    </ul>

                    <div class="section-title">📚 Coaching Achievements</div>
                    <ul>
                      <li>Expert in personalized coaching for players of all levels – from beginners to advanced competitors</li>
                      <li>Special focus on <b>strategy, discipline, critical thinking, and mental strength</b></li>
                      <li>Passionate about nurturing young talent and developing life skills through chess</li>
                    </ul>
                  </div>
              ...
              <div class="col-xl-7 col-lg-7 col-md-6 col-sm-12 mb-4 wow fadeInUp" data-wow-duration="1s"data-wow-delay=".3s">
                  <div class="row">
                     <div class="col-md-6">
