<?php 
$pageTitle = "Online Classes | GKS Chess Academy";
$pageDescription = "Join GKS Chess Academy's expert-led online chess classes from the comfort of your home. Ideal for all age groups and levels.";
$pageKeywords = "online chess coaching, virtual chess classes, GKS online training";
$pageCanonical = "https://gkschessacademy.com/online-classes";
            ...
            <div class="col-xl-10">
              <div class="bd-breadcrumb d-flex align-items-center justify-content-center">
                <div class="bd-breadcrumb-content text-center">
                  <h1 class="bd-breadcrumb-title">Online Classes</h1>
