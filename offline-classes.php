<?php 
$pageTitle = "Offline Classes | GKS Chess Academy";
$pageDescription = "Explore GKS Chess Academy's in-person Offline Classes designed for all levels to build strong chess foundations.";
            ...
            <div class="col-xl-10">
              <div class="bd-breadcrumb d-flex align-items-center justify-content-center">
                <div class="bd-breadcrumb-content text-center">
                  <h1 class="bd-breadcrumb-title">Offline Classes</h1>
