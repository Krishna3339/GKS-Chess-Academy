...
<!-- pre loader area start -->
   ...
   <!-- back to top start -->
   <div class="progress-wrap-wp">
      <a href="https://api.whatsapp.com/send/?phone=919353012221&text=Hello%20there%2C%20I%20want%20to%20talk%20to%20you.&app_absent=0" target="_blank">
       <svg  class="progress-circle svg-content"xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
   ...
   <header>
      <div class="bd-header">
         ...
         <div class="bd-header-top bd-header-top-2 d-none d-xl-block" style="display: none !important;">
                        ...
                        <div class="bd-header-top-left">
                           <div class="bd-header-meta-items-2  d-flex align-items-center">
                              ...
                              <div class="bd-header-meta-item d-flex align-items-center">
                                 ...
                                 <div class="bd-header-meta-text">
                                    <p><a href="">opposite Vinayaka Jewellers, Devasandra Main Rd, Krishnarajapuram, Bengaluru – 560036</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="bd-header-top-right d-flex align-items-center">
                           <div class="bd-header-meta-items d-flex align-items-center">
                              <div class="bd-header-meta-item d-flex align-items-center">
                                 ...
                                 <div class="bd-header-meta-text">
                                    <p><a href="mailto:support@kindedo.com">gkschessacademy@gmail.com</a></p>
                                 </div>
                              </div>
                              <div class="bd-header-meta-item d-flex align-items-center">
                                 <div class="bd-header-meta-icon">
            ...
            <div class="container">
               <div class="mega-menu-wrapper p-relative">
                  <div class="d-flex align-items-center justify-content-between">
                              ...
                              <li class="has-dropdown has-mega-menu">
                                  ...
                                  <ul class="mega-menu mega-menu-2">
                                    <li>
                                      ...
                                      <ul>
                                        <li>
                                          <a href="academy-classes" class="mega-program">
                                          ...
                                          <div class="mega-menu-2-inner-thumb p-relative">
                                            ...
                                            <div class="mega-menu-2-inner-thumb-content">
                                              ...
                                              <div class="mega-menu-2-inner-thumb-btn mb-25">
                                                <a href="contact" class="mega-btn">View More</a>
                                              </div>
                                            </div>
                                          </div>
                                        </li>
                     ...
                     <!--<div class="bd-header-bottom-right d-flex justify-content-end align-items-center" style="display:none;">-->
                     ...
                     <!--   </div>-->
                        <div class="bd-header-btn d-none d-xl-block">
                           <a href="https://docs.google.com/forms/d/e/1FAIpQLSftkfyUYlHi4XjH3woazH4VmXuzDIt3wKKVNQLe5zMWpcfiyg/viewform" class="bd-btn" target="_blank">
