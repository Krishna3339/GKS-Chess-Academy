  <footer>
      <div class="bd-footer-area fix pt-170 theme-bg-6">
         ...
         <div class="theme-bg bd-footer-wrapper p-relative pt-60">
            <div class="container">
               <!-- footer area bg here  -->
               <div class="bd-footer-bg-2" data-background="assets/img/bg/footer-banner.jpg"></div>
               <div class="bd-footer-top">
                  <div class="row align-items-end">
                     <div class="col-lg-6">
                        <div class="bd-footer-top-widget-1 mb-60">
                           <div class="bd-footer-logo mb-15">
                              <a href="index"> <img src="assets/img/logo/kiran.png" alt="img not found!"></a>
                           </div>
                     ...
                     <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="bd-footer-widget-2 mb-50">
                           <div class="bd-footer-widget-content">
                              ...
                              <div class="bd-footer-list bd-footer-list-2">
                                 <ul>
                                    <li><a href="/academy-classes">Academy Classes</a></li>
                                     <li><a href="/online-classes">Online Classes</a></li>
                                     <li><a href="/doorstep-coaching">Doorstep Coaching</a></li>
                                     <li><a href="/gated-communities">Gated Communities</a></li>
                                     <li><a href="/tournament-preparation">Tournament Preparation</a></li>
                              ...
                              <div class="bd-footer-list bd-footer-list-2">
                                ...
                                <div class="bd-footer-social-wrapper is-white">
                                  <div class="bd-footer-social">
                                    <a href="/404" rel="nofollow"><i class="fa-brands fa-facebook-f"></i>facebook</a>
                                  </div>
                                  <div class="bd-footer-social">
                                    <a href="/404" rel="nofollow"><i class="fa-brands fa-twitter"></i>twitter</a>
                                  </div>
                                  <div class="bd-footer-social">
                                    <a href="/404" rel="nofollow"><i class="fa-brands fa-youtube"></i>youtube</a>
                                  </div>
                                </div>
                              </div>
                           </div>
                        ...
                        <div class="bd-footer-widget-2 mb-50">
                           <div class="bd-footer-widget-content">
                              ...
                              <div class="bd-footer-contact is-white">
                                 <ul>
                                    <li><i class="fa-light fa-location-dot"></i><a href="#">Bengaluru, Karnataka – 560049.</a></li>
                                    <li><i class="fa-light fa-phone"></i><a href="tel:9353012221">935-302-221</a></li>
                                    <li><i class="fa-light fa-envelope"></i><a
                                          href="mailto:gkschessacademy@gmail.com">gkschessacademy@gmail.com</a></li>
                                 </ul>
                              </div>
                           </div>
                        </div>
               ...
               <div class="bd-footer-copyright pb-5 pt-25">
                  <div class="bd-footer-copyright-wrap d-flex justify-content-center">
                     <div class="bd-footer-copyright-text is-white pb-20">
                        <p>&copy; 2025 <a href="https://gkschessacademy.com/" rel="nofollow">Krishna</a>. All content is protected under copyright law.</p>
               ...
               <ul>
                  <li class="d-flex align-items-center gap-2">
                     ...
                     <div class="offcanvas__contact-text">
                        <a target="_blank"
                           href="https://www.google.com/maps/place/Dhaka/@23.7806207,90.3492859,12z/data=!3m1!4b1!4m5!3m4!1s0x3755b8b087026b81:0x8fa563bbdd5904c2!8m2!3d23.8104753!4d90.4119873">Bengaluru, Karnataka – 560049.</a>
                     </div>
                  </li>
                  <li class="d-flex align-items-center gap-2">
                     <div class="offcanvas__contact-icon">
                        <a href="tel:+917676521112"><i class="far fa-phone"></i></a>
                     </div>
                     <div class="offcanvas__contact-text">
                        <a href="tel:+919353012221">9353012221</a>
                     </div>
                  </li>
                  <li class="d-flex align-items-center gap-2">
                     <div class="offcanvas__contact-icon">
                        <a href="mailto:gkschessacademy@gmail.com"><i class="fal fa-envelope"></i></a>
                     </div>
                     <div class="offcanvas__contact-text">
                        <a href="mailto:gkschessacademy@gmail.com">gkschessacademy@gmail.com</a>
                     </div>
                  </li>
               </ul>
            </div>
