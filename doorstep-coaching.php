<?php 
$pageTitle = "Doorstep Coaching | GKS Chess Academy";
$pageDescription = "Experience personalized chess training at your doorstep with GKS Chess Academy. Ideal for students who prefer in-person coaching at home.";
$pageKeywords = "chess coaching at home, doorstep chess training, personal chess tutor";
$pageCanonical = "https://gkschessacademy.com/doorstep-coaching";
            ...
            <div class="col-xl-10">
              <div class="bd-breadcrumb d-flex align-items-center justify-content-center">
                <div class="bd-breadcrumb-content text-center">
                  <h1 class="bd-breadcrumb-title">Doorstep Coaching</h1>
                  <div class="bd-breadcrumb-list">
                    <span><a href="index"><i class="flaticon-hut"></i>GKS</a></span>
                    <span>Doorstep Coaching</span>
                  </div>
                </div>
              </div>
            </div>
