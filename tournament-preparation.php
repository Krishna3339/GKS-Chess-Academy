<?php 
$pageTitle = "Tournament Preparation | GKS Chess Academy";
$pageDescription = "Get your child tournament-ready with GKS Chess Academy's expert chess coaching and strategy sessions tailored for competitive play.";
$pageKeywords = "chess tournament training, chess competition preparation, advanced chess coaching";
$pageCanonical = "https://gkschessacademy.com/tournament-preparation";
            ...
            <div class="col-xl-10">
              <div class="bd-breadcrumb d-flex align-items-center justify-content-center">
                <div class="bd-breadcrumb-content text-center">
                  <h1 class="bd-breadcrumb-title">Tournament Preparation</h1>
