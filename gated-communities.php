<?php 
$pageTitle = "Gated Communities Coaching | GKS Chess Academy";
$pageDescription = "GKS Chess Academy offers structured chess coaching for gated communities, providing expert training within your residential area.";
$pageKeywords = "gated community chess classes, apartment chess coaching, society-based chess training";
$pageCanonical = "https://gkschessacademy.com/gated-communities";
            ...
            <div class="col-xl-10">
              <div class="bd-breadcrumb d-flex align-items-center justify-content-center">
                <div class="bd-breadcrumb-content text-center">
                  <h1 class="bd-breadcrumb-title">Gated Communities</h1>
